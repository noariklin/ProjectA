...
VALIDATE_ALL = False
PREDICT = False
# RESTORE_ID = 10546078818326650091
# RESTORE_EPOCH = 4
# LOG_COMETML_EXISTING_EXPERIMENT = "26ab3657b3ab4a9a99c60023af9e1201"

#general settings
SAVE_CHECKPOINTS = True #set to true to create a checkpoint at every epoch
EXPERIMENT_TAGS = ["First"]
EXPERIMENT_NAME = "no-new-net"
EPOCHS = 150
BATCH_SIZE = 2
VIRTUAL_BATCHSIZE = 2
...
if LOG_COMETML:
    if not "LOG_COMETML_EXISTING_EXPERIMENT" in locals():
        experiment = Experiment(api_key="ovnvJAztW7p5VQA9J9JOjoawU",project_name="project-a",workspace="noariklin")
    else:
        experiment = ExistingExperiment(api_key="ovnvJAztW7p5VQA9J9JOjoawU", previous_experiment=LOG_COMETML_EXISTING_EXPERIMENT, project_name="project-a", workspace="noariklin")
else:
    experiment = None
